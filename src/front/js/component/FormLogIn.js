...
export const FormLogIn = (props) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("https://didactic-eureka-g4q7rr9x7xrxhv6g9-3001.app.github.dev/login", { 
  ...
  return (
    <div className="contenedor">
      <div className="login">
        ...
        <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" className="forgot-password">¿Olvidaste tu contraseña?</a>
