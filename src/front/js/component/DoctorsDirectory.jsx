                        ...
                        <div key={index} className="col-md-4 mb-4">
                            <div className="card-custom">
                                <div className="card-body d-flex align-items-center">
                                    <div className="pe-3">
                                        <img src={doctor.image} alt={doctor.name} className="rounded-circle shadow-sm" style={{ width: '6rem', height: '6rem', objectFit: 'cover' }} />
                                    </div>
                                    <div>
                                        {doctor.destacado && (
                                        ...
                                        <Link to={`/doctor/${doctor.id}`} className="text-decoration-none">
                                            <h2 className="h5 text-dark fw-bold">{doctor.name}</h2>
                                        </Link>
                                        <p className="text-secondary mb-0">{doctor.specialty}</p>
                                        <div className="d-flex align-items-center">
                                            ...
                                            <span className="ms-2 text-secondary">{doctor.reviews} Opiniones</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-4">
                                    <p className="text-secondary mb-1">{doctor.city}</p>
                                    <p className="text-secondary mb-1">Costo de la consulta: {doctor.consultationCost}</p>
                                    <p className="text-secondary mb-0">Dirección: {doctor.address}</p>
                                </div>
                            </div>
                        </div>
                    ))
